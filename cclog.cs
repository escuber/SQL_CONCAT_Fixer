...
//	cclog.cs																		//
//																					//
//	Purpose: just an old fashond log project i made more than 20 years ago    		//
//																					//
//																					//
//																					//
// ********************************************************************************	//
...
//using System.Threading;
        ...
        */
        ...
        public static string getLogFileName()
        {
            ...
            try
            {
                ...
                fname = "";
                if (fname.Length <= 0) fname = @"C:\devlab\cclog.txt";
    ...
    public static bool wlf(string s)
    {
        WaitLog(s);
        return true;
    }
